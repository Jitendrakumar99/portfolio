...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: <FaEnvelope className="text-2xl" />, text: "Kumarjitendra6839@gmail.com", href: "mailto:your.email@example.com" },
    { icon: <FaPhone className="text-2xl" />, text: "6299607595", href: "tel:+1234567890" },
    { icon: <FaLinkedin className="text-2xl" />, text: "LinkedIn Profile", href: "https://www.linkedin.com/in/jitendra-kumar-530b78260/" },
    { icon: <FaGithub className="text-2xl" />, text: "GitHub Profile", href: "https://github.com/Jitendrakumar99" },
    { icon: <FaTwitter className="text-2xl" />, text: "Twitter Profile", href: "https://twitter.com/Jitendra6839" }
  ];
