        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          <div ref={textRef} className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              My journey in tech started with a curiosity for creating beautiful and functional web applications.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <span className="text-blue-400">▹</span>
                <p className="text-gray-300">Experience: 1 years in web development</p> 
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-blue-400">▹</span>
              ...
              <a
                href="https://drive.google.com/file/d/1Qc1wz8i9JI9gUOtBJmU72suny_c9NoYW/view?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
                onClick={(e) => {
                  e.preventDefault();
                  window.open('https://drive.google.com/uc?export=download&id=1Qc1wz8i9JI9gUOtBJmU72suny_c9NoYW', '_self');
                }}
